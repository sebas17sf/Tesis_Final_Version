                            ...
                            <tbody class="mdc-data-table__content ng-star-inserted">
                                @foreach ($asignacionesProyectos as $asignaciones)
                                    <tr class="mat-mdc-row mdc-data-table__row ng-star-inserted">
                                        ...
                                        <td style="text-align:justify; text-transform: uppercase; word-wrap: break-word;" >{{ $asignaciones->proyecto->nombreProyecto }}</td>
                                        <td style="text-align:center; text-transform: uppercase; word-wrap: break-word;" >{{ $asignaciones->proyecto->codigoProyecto }}</td>
                                        <td style="text-align:left; text-transform: uppercase; word-wrap: break-word;" >{{ $asignaciones->proyecto->director->nombres }}
                                            {{ $asignaciones->proyecto->director->apellidos }}</td>
                                        <td style="text-align:center; text-transform: uppercase; word-wrap: break-word;" >{{ $asignaciones->proyecto->departamentoTutor }}</td>
                                        <td style="text-align:left; text-transform: uppercase; word-wrap: break-word;" >{{ $asignaciones->docenteParticipante->nombres }}
                                            {{ $asignaciones->docenteParticipante->apellidos }}</td>
                                        <td style="text-align:left; text-transform: uppercase; word-wrap: break-word;" >{{ $asignaciones->docenteParticipante->departamento }}</td>
                                        <td style="text-align:left; text-transform: uppercase; word-wrap: break-word;" >{{ $asignaciones->estudiante->nombres }}
                                            {{ $asignaciones->estudiante->apellidos }}</td>
                                        <td style="text-align:center; text-transform: uppercase; word-wrap: break-word;" >{{ $asignaciones->periodo->numeroPeriodo }}</td>
                                        <td style="text-align:left; text-transform: uppercase; word-wrap: break-word;" >{{ $asignaciones->estudiante->carrera}}</td>
                                        <td style="text-align:center; text-transform: uppercase; word-wrap: break-word;" >{{ $asignaciones->estudiante->notas->notaFinal ?? "AUN NO TIENE NOTA"}}</td>
                                        <td style="text-align:center; text-transform: uppercase; word-wrap: break-word;" >{{ $asignaciones->inicioFecha }}</td>
                                        <td style="text-align:center; text-transform: uppercase; word-wrap: break-word;" >{{ $asignaciones->finalizacionFecha }}</td>
