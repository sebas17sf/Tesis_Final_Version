                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" id="nombres" name="nombres" class="form-control input"
                            ...
                            value="{{ old('nombres', session('docente') ? session('docente')->nombres : '') }}" required>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="email" id="correo" name="correo" class="form-control input"
                            ...
                            value="{{ old('correo', session('docente') ? session('docente')->correo : '') }}" required>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" id="cedula" name="cedula" class="form-control input"
                            ...
                            value="{{ old('cedula', session('docente') ? session('docente')->cedula : '') }}" required>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" id="espe_id" name="espe_id" class="form-control input"
                            ...
                            value="{{ old('espe_id', session('docente') ? session('docente')->espeId : '') }}" required>
