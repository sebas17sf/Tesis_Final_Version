            ...
            <form action="{{ route('ParticipanteVinculacion.register') }}" method="post" id="participantForm">
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <span id="error-nombre" style="color: red; font-size: 14px; display: block; margin-top: 5px;"></span>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <span id="error-apellidos" style="color: red; font-size: 14px; display: block; margin-top: 5px;"></span>
                        @error('apellidos')
                        <span style="color: red; font-size: 14px; display: block; margin-top: 5px;">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <span id="correoError" style="color: red; font-size: 14px; display: block; margin-top: 5px;"></span>
                        @error('correo')
                        <span style="color: red; font-size: 14px; display: block; margin-top: 5px;">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <span id="cedulaError" style="color: red; font-size: 14px; display: block; margin-top: 5px;"></span>
                        @error('cedula')
                        <span style="color: red; font-size: 14px; display: block; margin-top: 5px;">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <span id="espeIdError" style="color: red; font-size: 14px; display: block; margin-top: 5px;"></span>
                        @error('espe_id')
                        <span style="color: red; font-size: 14px; display: block; margin-top: 5px;">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <span id="departamentoError" style="color: red; font-size: 14px; display: block; margin-top: 5px;"></span>
                    </div>
                </div>
