                        ...
                        <div class="col-md-6">
                            <form method="POST" action="{{ route('coordinador.reportesProyectos') }}">
                                ...
                                <div class="form-inline">
                                    <label for="elementosPorPaginaAprobados">Estado del Proyecto:</label>
                    ...
                    <div class="contenedor_buscador">
                        <div>
                            <form id="formBusquedaProyectos">
                                <input type="text" class="input" name="search" value="{{ $search }}" matInput placeholder="Buscar proyectos...">
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div id="asignarEstudiante" style="display: none;">
                    ...
                    <form method="POST" action="{{ route('admin.guardarAsignacion') }}">
                        ...
                        <button type="submit" class="button efects_button">Asignar Proyecto</button>
                    </form>
