...
<div class="mat-elevation-z8">
    <div class="card" style="margin: auto; max-width: 800px; box-shadow: 0 6px 10px 0 rgba(64, 69, 108, 0.6); transition: 0.5s;">
        <div class="card-body" style="padding: 1rem; text-align: center;">
            ...
            <hr>
            <form id="editarProyectos" action="{{ route('admin.updateProyecto', ['ProyectoID' => $proyecto->proyectoId]) }}" method="POST" style="display: inline-block; width: 100%; max-width: 600px;">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-12">
