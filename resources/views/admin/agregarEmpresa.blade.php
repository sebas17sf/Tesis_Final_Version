                ...
                <table class="table table-bordered">
                    <tbody>
                        <tr>
                            ...
                            <td><input type="text" class="form-control input" id="nombreEmpresa" name="nombreEmpresa" placeholder="Ingrese el Nombre de la Empresa" required>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><input class="form-control input" id="ciudad" name="ciudad" placeholder="Ingrese la Ciudad" required></input></td>
                        </tr>

                        <tr>
                            <td><label for="direccion">Dirección:</label></td>
                            <td><input class="form-control input" id="direccion" name="direccion" placeholder="Ingrese la Direccion" required></input></td>
                        </tr>


                        <tr>
                            <td><label for="correo">Correo de contacto de la Empresa:</label></td>
                            <td><input type="email" class="form-control input" id="correo" name="correo" placeholder="Ingrese el Correo de la Empresa" required></td>
                        </tr>

                        <tr>
                            <td><label for="nombreContacto">Nombre del contacto de la Empresa:</label></td>
                            <td><input type="text" class="form-control input" id="nombreContacto" name="nombreContacto"
                        ...
                        <tr>
                            ...
                            <td>
                             <input type="text" class="form-control input" id="telefonoContacto" name="telefonoContacto" 
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea class="form-control input" id="actividadesMacro" name="actividadesMacro" rows="4" placeholder="Ingrese las actividades macro requeridas" required></textarea>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                            <input type="text" class="form-control input" id="cuposDisponibles" name="cuposDisponibles" 
                        ...
                        <tr>
                            ...
                            <td><input type="file" class="form-control-file input input_file" id="cartaCompromiso" name="cartaCompromiso">
                            </td>
                        </tr>

                        <tr>
                            <td><label for="convenio">Convenio (PDF):</label></td>
                            <td><input type="file" class="form-control-file input input_file" id="convenio" name="convenio"></td>
                        </tr>
        ...
        @else
            <div class="d-flex">
                <form method="GET" action="{{ route('admin.agregarEmpresa') }}" class="mr-3">
                    ...
                    <select name="elementosPorPagina" id="elementosPorPagina" class="input input-select" onchange="this.form.submit()">
