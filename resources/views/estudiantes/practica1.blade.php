...
@section('content')
    ...
    @if (isset($practicaPendiente))
        ...
        <!-- Tabla de detalles de la práctica -->
        <div class="row">
            <div class="col-md-6">
    ...
    @else
        ...
        <form action="{{ route('guardarPracticas') }}" method="POST">
                ...
                <table class="table2 table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style=" text-transform: uppercase; font-size: 13px;">{{ strtoupper($estudiante->apellidos) }} {{ strtoupper($estudiante->nombres) }}</td>
                        </tr>
                        <tr>
            ...
            <br>
            <button type="button" id="verOpcionesBtn" class="button1 btn3"><i class="fa-regular fa-magnifying-glass-plus"></i> Ver opciones de prácticas</button>
            <br>
            <hr>
            <div class="table-responsive-sm">
                <table id="opcionesPracticas" class="table2 table table-bordered" style="display: none;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <label for="ID_tutorAcademico"></label>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="Funcion" name="Funcion" class="form-control input input_select3" placeholder="Ingrese la función del tutor empresarial">
                            </td>
                        </tr>
                        <tr>
                            <th style=" text-transform: uppercase; font-size: 13px; color: rgba(26, 26, 26, 0.753);"><b>Teléfono:</b></th>
