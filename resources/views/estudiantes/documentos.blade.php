                ...
                <div class="draggable-card1_4" id="cardRegistroActividades" style="display: none;">
                    <div class="card-header">
                        ...
                        <button type="button" class="close"
                            onclick="closeCard('cardRegistroActividades')">&times;</button>
                    </div>
                    <div class="card-body">
                                                    ...
                                                    <td
                                                        ...
                                                        <div class="btn-group shadow-1">
                                                            <form
                                                                ...
                                                                method="POST"
                                                                id="delete-form-{{ $actividad->idActividades }}">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="button"
                                                                ...
                                                                <div class="card-body">
                                                                    <form
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="input-group input_file">
                                                                                <span
                                                                                    id="fileText{{ $actividad->idActividades }}"
                        ...
                        <form action="{{ route('estudiantes.generarInforme') }}" method="post">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="tooltip-container">
                                    ...
                                    <button type="button" class="button3 efects_button btn_eliminar1"
                            ...
                            <table class="four-column-table">
                                ...
                                <tr>
                                    <td>
                                        <label for="conclusiones1">¿Qué resultados de aprendizaje obtuvo realizando las
                                            actividades de servicio comunitario?</label>
                                    </td>
                                    <td class="textarea-cell">
                                        <textarea id="conclusiones1" class="textarea input" name="conclusiones1" rows="10"></textarea>
                                    </td>
                                    <td>
                                        <label for="conclusiones2">¿Qué limitaciones tuvo para realizar sus actividades de
                                            servicio comunitario?</label>
                                    </td>
                                    <td class="textarea-cell">
                                ...
                                <tr>
                                    <td>
                                        <label for="conclusiones3">¿Qué éxitos alcanzados se obtuvo cuando realizó sus
                                            actividades de servicio comunitario?</label>
                                    </td>
                                    <td class="textarea-cell">
