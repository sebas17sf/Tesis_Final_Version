...
Route::get('/reset-password/{correoElectronico}', [LoginController::class, 'mostrarFormularioRestablecimiento'])->name('mostrar-formulario-restablecimiento');

///ruta para ingresar la nueva contraseña
Route::post('/reset-password/{correoElectronico}', [LoginController::class, 'cambiarContrasenaUsuario'])->name('restablecer-contrasena');
